...
public class ClearUserThreadPoolExecutorHandler {
    ...
    public void createThreadPool() {
        ...
        for (int i = 0; i < totalTaskSize; i++) {
            SimplyThreadPoolTask ttp = new SimplyThreadPoolTask(i);
//            System.out.println("put i:" + i);
    ...
    public static void main(String[] args) {
        ClearUserThreadPoolExecutorHandler test = new ClearUserThreadPoolExecutorHandler();
